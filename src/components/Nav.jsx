  ...
  return (
    <nav className="fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50">
      <div className="container mx-auto">
        <div className="w-full bg-black/20 h-[86px] backdrop-blur-2xl items-center rounded-full max-w-[460px] mx-auto px-5 flex justify-between text-1xl text-white/50">
