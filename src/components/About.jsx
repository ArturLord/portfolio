  ...
  return (
    <section className="section" ref={ref} id="about">
      <div className="container mx-auto text-center w-[960px] flex justify-center lg:block lg:text-left">
        <div className="flex flex-col gap-y-10 lg:flex-row-reverse lg:items-center justify-center lg:gap-x-40 lg:gap-y-0 h-screen">
          <motion.div
            variants={fadeIn('left', 0.5)}
            initial="hidden"
            whileInView={'show'}
            viewport={{ once: false, amount: 0.3 }}
            className="flex-1 bg-about bg-contain bg-no-repeat h-[520px] mix-blend-lighten"
          >
          </motion.div>
          <motion.div
          ...
          >
            ...
            <div className="flex gap-x-9 lg:gap-x-10 text-center mb-12">
              <div>
